...
template <typename _Tf>
int16_t base_candle_hloc<_Tf>::code() const
{
   if ( m_nHigh == m_nLow )
      return 0b10000; // 16
...
//
template <typename _Tf>
_Tf base_candle_hloc<_Tf>::like(const _Tf nOpenPosition, const _Tf nClosePosition) const
{
...
//
template <typename _Tf>
_Tf distance(const base_candle_hloc<_Tf> *pCandle1, const base_candle_hloc<_Tf> *pCandle2)
{
...
struct base_candle_hlocv: public base_candle_hloc<_Tf>
{
   _Tv m_nVolume;
};   
//
...
//
template <typename _Tf, typename _Tv>
struct base_candle: public base_candle_hlocv<_Tf, _Tv>, public datetime
{
};   
//
// -----------------------------------------------------------------------------
